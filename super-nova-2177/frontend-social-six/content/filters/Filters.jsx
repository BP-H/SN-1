...
function Filters({ filter, setFilter }) {
  ...
  return (
    <button
      type="button"
      className="relative z-50 flex min-h-11 w-full min-w-[9.5rem] flex-col justify-center rounded-[16px] bg-white px-3 py-2 text-left shadow-md lg:w-[12rem]"
    ...
    >
      ...
      <div
        className={`${open ? "" : "hidden"} absolute left-0 top-[calc(100%+0.45rem)] w-full rounded-[18px] border border-[var(--horizontal-line)] bg-white p-1 shadow-lg`}
      >
