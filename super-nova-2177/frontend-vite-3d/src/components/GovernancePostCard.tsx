...
export const GovernancePostCard: React.FC<PostCardProps> = ({ item, type }) => {
    ...
    const renderMedia = () => {
        ...
        const fullUrl = mediaUrl.startsWith('http') ? mediaUrl : `${(import.meta.env.VITE_API_URL || 'http://127.0.0.1:8000').replace(/\/$/, '')}${cleanPath}`;
