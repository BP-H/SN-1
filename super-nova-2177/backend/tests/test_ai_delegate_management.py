...
class AiDelegateManagementTests(unittest.TestCase):
    ...
    def test_ai_genesis_page_uses_call_sign_flow_not_account_form_labels(self):
        ...
        self.assertIn('const GENESIS_STEPS = ["Name", "Traits", "Persona", "Approve"]', page)
        ...
        self.assertIn("const isActive = currentGenesisStep === step;", page)
        self.assertIn('aria-current={isActive ? "step" : undefined}', page)
    ...
    def test_ai_actions_ui_surfaces_generation_metadata(self):
        ...
        self.assertIn("Create one here, or open the full Genesis page.", ai_picker)
